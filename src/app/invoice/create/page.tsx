...
export default function CreateInvoice() {
  ...
  return (
    ...
    // <div className="flex flex-col min-h-screen pb-16">
    //   <Header />
    //   <main className="flex-1 p-8 max-w-3xl w-[95%] mx-auto text-center">
    //     <div className="bg-white p-8 rounded-lg shadow-lg mt-3 mb-18 text-left w-full max-w-xl mx-auto text-xl">
    //       <h1 className="text-4xl mb-8 text-center text-gray-800 font-bold">請求書の作成</h1>
    //       <label htmlFor="recipient" className="block text-2xl mt-6 mb-3 text-gray-600 font-medium">送り先:</label>
    //       <input
    //         type="text"
    ...
    <div className="flex flex-col min-h-screen pb-16">
      <Header />
      <main className="flex-1 p-4 sm:p-8 max-w-3xl w-full mx-auto text-center">
        <div className="bg-white p-4 sm:p-8 rounded-lg shadow-lg mt-3 mb-18 text-left w-full max-w-xl mx-auto text-base sm:text-xl">
          <h1 className="text-3xl sm:text-4xl mb-6 sm:mb-8 text-center text-gray-800 font-bold">請求書の作成</h1>
          <form onSubmit={(e) => e.preventDefault()}>
            <label htmlFor="recipient" className="block text-xl sm:text-2xl mt-4 sm:mt-6 mb-2 sm:mb-3 text-gray-600 font-medium">送り先:</label>
            <input
              type="text"
              id="recipient"
              placeholder="送る相手の名前を入力してください"
              value={recipient}
              onChange={(e) => setRecipient(e.target.value)}
              className="w-full p-3 sm:p-4 text-base sm:text-lg border border-gray-300 rounded-md font-medium"
            />
            <label htmlFor="amount" className="block text-xl sm:text-2xl mt-4 sm:mt-6 mb-2 sm:mb-3 text-gray-600 font-medium">金額:</label>
            <input
              type="number"
              id="amount"
              placeholder="金額を入力してください"
              ...
              className="w-full p-3 sm:p-4 text-base sm:text-lg border border-gray-300 rounded-md font-medium"
            />
            <label htmlFor="due_date" className="block text-xl sm:text-2xl mt-4 sm:mt-6 mb-2 sm:mb-3 text-gray-600 font-medium">支払い期限:</label>
            <input
              type="date"
              id="due_date"
              value={dueDate}
              ...
              className="w-full p-3 sm:p-4 text-base sm:text-lg border border-gray-300 rounded-md font-medium"
            />
            <label htmlFor="message" className="block text-xl sm:text-2xl mt-4 sm:mt-6 mb-2 sm:mb-3 text-gray-600 font-medium">メッセージ:</label>
            <textarea
              id="message"
              placeholder="メッセージを入力してください"
              value={message}
              onChange={(e) => setMessage(e.target.value)}
              className="w-full p-3 sm:p-4 text-base sm:text-lg border border-gray-300 rounded-md h-24 sm:h-32 resize-y"
            />
            <button 
              className="bg-[#00B900] hover:bg-[#009300] text-white py-3 sm:py-4 px-6 sm:px-8 rounded-md text-xl sm:text-2xl cursor-pointer w-full mt-6 sm:mt-8 font-bold"
              onClick={handleCreateInvoice}
              disabled={isCreating || isRedirecting}
            >
              この内容で請求書を作成
