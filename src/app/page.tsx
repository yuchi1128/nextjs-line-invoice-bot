  ...
  return (
    <div className="home">
      ...
      <div className="home__content">
        {isLoggedIn ? (
          <>
            <img className="home__profile-img" src={profile.picture} alt="Profile" width="100" height="100" />
            <h2 className="home__greeting">こんにちは！{profile.name}さん！</h2>
            <Link href="/create-invoice" className="home__button button--primary">
              請求書を作成
            </Link>
          </>
        ) : (
          <>
            <h2 className="home__message">ログインされていません。</h2>
            <button className="home__button button--primary" onClick={handleLogin}>
              LINEでログイン
            </button>
          </>
        )}
