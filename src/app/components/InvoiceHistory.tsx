              ...
              <div className="bg-white rounded-lg shadow-md p-4 hover:shadow-lg transition duration-300">
                <div className="flex justify-between items-center mb-2">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-600">{new Date(invoice.sentDate).toLocaleDateString()}</span>
                  </div>
                  <div className={`text-sm font-semibold ${invoice.isPaid ? 'text-green-600' : 'text-red-600'}`}>
                    {invoice.isPaid ? '精算済み' : '未精算'}
                  </div>
                </div>
                <div className="flex justify-between items-center">
